...
class AnthbotDevice {
    ...
    setShadowState() {
        ...
        // Network state
        this.setStateChanged(`status.4g_state`, this.shadowState.net_state?.['4g_state'] == 1);
        this.setStateChanged(`status.wifi_state`, this.shadowState.net_state?.wifi_state == 1);
    }
